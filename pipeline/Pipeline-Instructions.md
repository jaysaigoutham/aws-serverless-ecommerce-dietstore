# aws-serverless-ecommerce-dietstore-pipeline
...
aws ssm put-parameter \
    --name "/service/aws-serverless-ecommerce-dietstore-pipeline/github/repo" \
    --description "Github Repository name for Cloudformation Stack aws-serverless-ecommerce-dietstore-pipeline-pipeline" \
    --type "String" \
    --value "GITHUB_REPO_NAME"

aws ssm put-parameter \
    --name "/service/aws-serverless-ecommerce-dietstore-pipeline/github/token" \
    --description "Github Token for Cloudformation Stack aws-serverless-ecommerce-dietstore-pipeline-pipeline" \
    --type "String" \
    --value "TOKEN"

aws ssm put-parameter \
    --name "/service/aws-serverless-ecommerce-dietstore-pipeline/github/user" \
    --description "Github Username for Cloudformation Stack aws-serverless-ecommerce-dietstore-pipeline-pipeline" \
    --type "String" \
    --value "GITHUB_USER"
```

**NOTE:** Keep in mind that these Parameters will only be available within the same region you're deploying this Pipeline stack. Also, if these values ever change you will need to [update these parameters](https://docs.aws.amazon.com/cli/latest/reference/ssm/put-parameter.html) as well as update the "aws-serverless-ecommerce-dietstore-pipeline-pipeline" Cloudformation stack.
...
aws cloudformation create-stack \
    --stack-name aws-serverless-ecommerce-dietstore-pipeline-pipeline \
